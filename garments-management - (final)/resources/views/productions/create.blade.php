...
@section('content')
<div class="container">
    <h1 class="h3 mb-4">Add New Production</h1>
    ...
    <form action="{{ route('productions.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="completed_qty" id="completed_qty" class="form-control" value="{{ old('completed_qty', 0) }}" min="0" required>
        </div>
