  ...
  <div class="navbar-wrapper">
    ...
    <li class="pc-item pc-hasmenu">
      ...
      <ul class="pc-submenu">
        ...
        <li class="pc-item"><a class="pc-link" href="#!">Order Status</a></li>
    ...
    <li class="pc-item pc-hasmenu">
      ...
      <ul class="pc-submenu">
        ...
        <li class="pc-item"><a class="pc-link" href="{{ route('supplies.index') }}">Add Product</a></li>
        <li class="pc-item"><a class="pc-link" href="{{ route('purchase_orders.index') }}">Purchase Orders</a></li>
      </ul>
    </li>
