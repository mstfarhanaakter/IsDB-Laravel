  ...
  <div class="navbar-wrapper">
    ...
    <li class="pc-item pc-hasmenu">
      ...
      <ul class="pc-submenu">
        ...
        <li class="pc-item"><a class="pc-link" href="{{ route('buyers.create') }}">Add New Buyer</a></li> -->
        <li class="pc-item"><a class="pc-link" href="{{ route('categories.index') }}">Product Categories</a></li>
        <li class="pc-item"><a class="pc-link" href="{{ route('products.index') }}">Products</a></li>
        <li class="pc-item"><a class="pc-link" href="{{ route('products.create') }}">Add New Product</a></li>
        ...
        <li class="pc-item"><a class="pc-link" href="{{ route('order_items.index') }}">Order Items</a></li>
        <li class="pc-item"><a class="pc-link" href="{{ route('buyers.orders') }}">Order Status</a></li>
        <li class="pc-item"><a class="pc-link" href="{{ route('deliveries.index') }}">Delivery</a></li>
      </ul>
    </li>
    ...
    <li class="pc-item pc-hasmenu">
          ...
          <ul class="pc-submenu">
            ...
            <li class="pc-item"><a class="pc-link" href="{{ route('productions.completed') }}">Completed Production</a></li>
          </ul>
        </li>
    ...
    <li class="pc-item pc-hasmenu">
      ...
      <ul class="pc-submenu">
        <li class="pc-item"><a class="pc-link" href="{{ route('buyers.index') }}">All Buyers</a></li>
        <li class="pc-item"><a class="pc-link" href="{{ route('buyers.create') }}">Add Buyer</a></li>
        <li class="pc-item"><a class="pc-link" href="{{ route('buyers.orders') }}">Buyer Orders</a></li>
      </ul>
    </li>
