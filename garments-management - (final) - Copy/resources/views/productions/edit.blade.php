                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" name="production_date" id="production_date" class="form-control" 
                               value="{{ old('production_date', $production->production_date->format('Y-m-d')) }}" required>
                    </div>

                    <!-- Planned Quantity -->
                    <div class="col-md-6">
                        <label for="planned_qty" class="form-label">Planned Quantity</label>
                        <input type="number" name="planned_qty" id="planned_qty" class="form-control" 
                               value="{{ old('planned_qty', $production->planned_qty) }}" min="0" required>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="produced_qty" id="produced_qty" class="form-control" 
                               value="{{ old('produced_qty', $production->produced_qty) }}" min="0">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="defect_qty" id="defect_qty" class="form-control" 
                               value="{{ old('defect_qty', $production->defect_qty) }}" min="0">
                    </div>

                    <!-- Remarks -->
                    <div class="col-12">
                        <label for="remarks" class="form-label">Remarks</label>
                        <textarea name="remarks" id="remarks" class="form-control" rows="3">{{ old('remarks', $production->remarks) }}</textarea>
                    </div>

                    <!-- Completed Checkbox -->
                    <div class="col-12">
                        <div class="form-check">
                            <input type="checkbox" name="is_completed" id="is_completed" class="form-check-input" value="1" {{ $production->is_completed ? 'checked' : '' }}>
