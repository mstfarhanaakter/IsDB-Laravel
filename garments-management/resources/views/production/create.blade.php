                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="is_completed" id="status" class="form-select" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="remarks" id="remarks" class="form-control" rows="2">{{ old('remarks', $production->remarks) }}</textarea>
                        </div>
                    </div>
                </div>
